...
class MLX90640_1:
    ...
    def frame_rate(self, frame_rate):
        ...
        frame_rate_code = MLX90640_1.frame_rate_to_bit_mask(frame_rate)
    ...
    def do_compensation(self, raw_frame, add_ambient_temperature=False):
        ...
        info_data[2] = round((Tamb - MLX90640_1.MIN_TEMP_DEGC) * MLX90640_1.LSB_DEGC)
        ...
        dTaPow4 = pow(Tamb - MLX90640_1.MIN_TEMP_DEGC, 4)
        ...
        for i in range(np):
            ...
            if fabs(alpha) < 1e-12:
                ...
                if d < 0.0:
                    ...
                    # pass2
                    To1 = pow(d, 0.25) + MLX90640_1.MIN_TEMP_DEGC
                    if self.calc_params.version >= 2:
                        ...
                        if d < 0.0:
                            ...
                            To = pow(d, 0.25) + MLX90640_1.MIN_TEMP_DEGC
                    else:
                        To = To1
...
class Mlx90640EEPROM:
    ...
    def __init__(self, device: MLX90640_1):
        self.device = device
        self.eeprom = None
...
if __name__ == "__main__":
    i2c_handle = SMBus(0)
    mlx = MLX90640_1(i2c_handle, i2c_addr=0x33, frame_rate=8.0)
